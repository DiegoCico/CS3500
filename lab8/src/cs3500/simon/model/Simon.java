...
/**
 * interface for simon that extends readonly.
 */
public interface Simon extends ReadOnlySimon {
  /**
   * A player guesses one color at a time, trying to mimic
   * the current contents of the sequence.
   * When the player guesses the entire sequence correctly,
   * the model adds a new color to the current
   * sequence.
