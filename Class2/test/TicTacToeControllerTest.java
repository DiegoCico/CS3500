...
public class TicTacToeControllerTest {
  ...
  @Test
  public void testOutOfBoundBehavior() {
    TicTacToe m = new TicTacToeModel();
    Reader in = new StringReader("1 10 q");
    StringBuilder gameLog = new StringBuilder();
    TicTacToeController controller =
            new TicTacToeConsoleController(in, gameLog);
    ...
    String expected = ""
            ...
            + "-----------\n"
            + "   |   |  ";
    Assert.assertEquals(expected, gameLog.toString());
  }
  ...
  public void testConfirmInputs() {
    ...
    TicTacToe m = new MockTTTConfirmInputs(mockLog);
    Reader in = new StringReader("0 0 1 2 3 4 q");
